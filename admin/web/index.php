            ...
            <div class="modal-content">
                ...
                <form id="donationForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="money" name="amount" required>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#donationForm').on('submit', function (e) {
                ...
                $.ajax({
                    url: '../function/php/save_data.php',  // URL of your PHP script to process the form
                    type: 'POST',
                    data: formData,
                    success: function (response) {
                        // On success, show the success message
                        $('#successMessage').fadeIn().delay(3000).fadeOut();
                        $('#exampleModal').modal('hide');   // Show message and hide after 3 seconds
                    },
